package
{
    ...
    /** QA-only: force the shipping PCPlayState.levelOver() path for all 72 variants. */
    public class QACampaignCompletionState extends PCPlayState
    {
        ...
        override public function update():void
        {
            ...
            if (!completed && FlxG.keys.justPressed("K"))
            {
                levelOver();
                completed = true;
                qaLabel.text = variantName() + "  COMPLETION_FORCED";
                return;
            }
            ...
            if (FlxG.keys.justPressed("N"))
            {
                ...
                FlxG.paused = false;
                FlxG.switchState(new QACampaignCompletionState);
                return;
            }
        }
        ...
        {
            return "QA-COMPLETE " + (qaIndex + 1) + "/72  " +
