    ...
    public class QAStateBoot extends FlxState
    {
        override public function create():void
        {
            ...
            var t:FlxText = new FlxText(20, 120, 600,
                "QA STATE BOOT\nQ menu  O options  H help  C credits\nL level select  A/S/D end cinematics  P old-school complete");
        ...
        override public function update():void
        {
            ...
            else if (FlxG.keys.justPressed("S")) { Registry.level = XML(new Registry.LevelEndScene2); Registry.levelType=2; Registry.levelNumber=12; FlxG.switchState(new PCCinematicState()); }
