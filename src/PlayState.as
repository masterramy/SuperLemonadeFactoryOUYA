package
{
	...
	public class PlayState extends FlxState
	{
		...
		[Embed(source = "../data/sfx_128/Registry.SndOnShoulders.mp3")] protected var Registry.SndOnShoulders:Class;		
		...
		private var hasCreatedLevel:Boolean = false;
		
		private var headingTxt:FlxText;
		private var headingSpr:FlxSprite;
		private var headingTxt2:FlxText;
		private var headingSpr2:FlxSprite;
		...
		public function loadMovingPlatform(item:XML, toLoad:String):void {
			...
			var img:Class;
			if (toLoad == "level1_specialPlatformSmall") img = Registry.level1_specialPlatformSmall;
			else if (toLoad == "level2_specialPlatformSmall") img = Registry.level2_specialPlatformSmall;
			else if (toLoad == "level3_specialPlatformSmall") img = Registry.level3_specialPlatformSmall;
			else if (toLoad == "level1_specialPlatform") img = Registry.level1_specialPlatform;
			else if (toLoad == "level2_specialPlatform") img = Registry.level2_specialPlatform;
			else if (toLoad == "level3_specialPlatform") img = Registry.level3_specialPlatform;
			else if (toLoad == "level1_specialBlock") img = Registry.level1_specialBlock;
			else if (toLoad == "level2_specialBlock") img = Registry.level2_specialBlock;
			else if (toLoad == "level3_specialBlock") img = Registry.level3_specialBlock;			
			else {
				if (toLoad == "level1_specialPlatform") img = Registry.level1_specialPlatform;
		...
		public function loadItem(item:XML, toLoad:String, overrideScrollFactor:int):void 
		{
			...
			if (toLoad == "cratesBox") img = Registry.cratesBox;
			else if (toLoad == "level1_windows") img = Registry.level1_windows;
			else if (toLoad == "palettes") img = Registry.palettes;
			else if (toLoad == "L1_Shelf") img = Registry.L1_Shelf;
			else if (toLoad == "level1_shelfTile") img = Registry.level1_shelfTile;
			else if (toLoad == "sodaPack") img = Registry.sodaPack;
			else if (toLoad == "sugarBags") img = Registry.sugarBags;
			else if (toLoad == "sugarBagsAndCrates") img = Registry.sugarBagsAndCrates;
			else if (toLoad == "noticeBoard") img = Registry.noticeBoard;
			
			else if (toLoad == "spike0") img = Registry.spike0;
			else if (toLoad == "spike1") img = Registry.spike1;
			else if (toLoad == "spike2") img = Registry.spike2;
			else if (toLoad == "spike3") img = Registry.spike3;
			
			else if (toLoad == "level1_specialBlock") img = Registry.level1_specialBlock;
			else if (toLoad == "level1_specialPlatform") img = Registry.level1_specialPlatform;
			
			else if (toLoad == "level1_specialPlatformSmall") img = Registry.level1_specialPlatformSmall;
			else if (toLoad == "level2_specialPlatformSmall") img = Registry.level2_specialPlatformSmall;
			else if (toLoad == "level3_specialPlatformSmall") img = Registry.level3_specialPlatformSmall;
			
			else if (toLoad == "level2_spike0") img = Registry.level2_spike0;
			else if (toLoad == "level2_spike1") img = Registry.level2_spike1;
			else if (toLoad == "level2_spike2") img = Registry.level2_spike2;
			else if (toLoad == "level2_spike3") img = Registry.level2_spike3;
			
			else if (toLoad == "level2_specialBlock") img = Registry.level2_specialBlock;
			else if (toLoad == "level2_specialPlatform") img = Registry.level2_specialPlatform;
			
			else if (toLoad == "level3_spike0") img = Registry.level3_spike0;
			else if (toLoad == "level3_spike1") img = Registry.level3_spike1;
			else if (toLoad == "level3_spike2") img = Registry.level3_spike2;
			else if (toLoad == "level3_spike3") img = Registry.level3_spike3;
			else if (toLoad == "level3_specialBlock") img = Registry.level3_specialBlock;
			else if (toLoad == "level3_specialPlatform") img = Registry.level3_specialPlatform;	
			else if (toLoad == "level2_braceLeft") img = Registry.level2_braceLeft;			
			else if (toLoad == "level2_braceRight") img = Registry.level2_braceRight;			
			else if (toLoad == "level2_chainTile") img = Registry.level2_chainTile;			
			else if (toLoad == "level2_FMG3") img = Registry.level2_FMG3;			
			else if (toLoad == "level2_greenPipe") img = Registry.level2_greenPipe;			
			else if (toLoad == "level2_metalPipe") img = Registry.level2_metalPipe;			
			else if (toLoad == "level2_MG2") img = Registry.level2_MG2;			
			else if (toLoad == "level2_pipe1") img = Registry.level2_pipe1;			
			else if (toLoad == "level2_tank") img = Registry.level2_tank;			
			else if (toLoad == "level2_window") img = Registry.level2_window;	
			
			else if (toLoad == "level3_window") img = Registry.level3_window;	
			else if (toLoad == "bookCase") img = Registry.bookCase;	
			
			// others now handled by special cases.
			
			//else if (toLoad == "filingCab1") img = Registry.filingCab1;	
			//else if (toLoad == "filingCab2") img = Registry.filingCab2;	
			//else if (toLoad == "plant1") img = Registry.plant1;	
			//else if (toLoad == "plant2") img = Registry.plant2;	
			
			else if (toLoad == "level3_cloud") img = Registry.level3_cloud;	
			else if (toLoad == "level3_desk1") img = Registry.level3_desk1;	
			else if (toLoad == "level3_desk2") img = Registry.level3_desk2;	
			else if (toLoad == "level3_desk3") img = Registry.level3_desk3;	
			else if (toLoad == "level3_MG_pylon") img = Registry.level3_MG_pylon;	
			else if (toLoad == "level3_painting1") img = Registry.level3_painting1;	
			else if (toLoad == "level3_painting2") img = Registry.level3_painting2;	
			else if (toLoad == "level3_painting3") img = Registry.level3_painting3;	
			else if (toLoad == "level3_salesChart") img = Registry.level3_salesChart;		
		...
		override public function create():void
		{
			...
			if (Registry.levelType==1) {
				FlxG.bgColor = 0xd3bdb2;
			}
			if (Registry.levelType==2) {
				FlxG.bgColor = Registry.BG_FACTORY_GREEN;
			}
			if (Registry.levelType==3) {
				FlxG.bgColor = Registry.BG_MGMT_BROWN;
			}
			...
			headingTxt = new FlxText(0, FlxG.height/2, FlxG.width, "Loading", true);
			headingTxt.color = Registry.WAREHOUSE_PURPLE;
			headingTxt.size = 40;
			headingTxt.alignment = "center";
			headingTxt.scrollFactor.x = 0;
			headingTxt.scrollFactor.y = 0;
			add(headingTxt);
		...
		{			
			...
			if (Registry.levelType==1) {
				...
				bg.loadTiles(Registry.level1_bgSmoothGrad, 1, 512, 0);
			...
			if (Registry.levelType==2) {
				...
				bg = new FlxTileblock(0, 0, FlxG.width, FlxG.height);
				bg.loadTiles(Registry.level2_gradient, 1, 512, 0);
				bg.scrollFactor.x = bg.scrollFactor.y = 0;
			...
			if (Registry.levelType==3) {
				...
				bg = new FlxTileblock(0, 0, FlxG.width, FlxG.height);
				bg.loadTiles(Registry.level3_gradient, 1, 512, 0);
				bg.scrollFactor.x = bg.scrollFactor.y = 0;
			...
			if (Registry.levelType==1) {				
				headingSpr = new FlxSprite(0, 0, null);
				headingSpr.makeGraphic(FlxG.width, FlxG.height, 0xffd3bdb2);
				headingSpr.scrollFactor.x = headingSpr.scrollFactor.y = 0;
				add(headingSpr);
				
			}
			if (Registry.levelType==2) {
				headingSpr = new FlxSprite(0, 0, null);
				headingSpr.makeGraphic(FlxG.width, FlxG.height, Registry.BG_FACTORY_GREEN);
				headingSpr.scrollFactor.x = headingSpr.scrollFactor.y = 0;
				add(headingSpr);
			}
			if (Registry.levelType==3) {
				...
				headingSpr = new FlxSprite(0, 0, null);
				headingSpr.makeGraphic(FlxG.width, FlxG.height, Registry.BG_MGMT_BROWN);
				headingSpr.scrollFactor.x = headingSpr.scrollFactor.y = 0;
				add(headingSpr);
			}	
			
			
			headingTxt2 = new FlxText(0, FlxG.height/2, FlxG.width, "Loading..", true);
			headingTxt2.color = Registry.WAREHOUSE_PURPLE;
			headingTxt2.size = 48;
			headingTxt2.alignment = "center";
			headingTxt2.scrollFactor.x = 0;
			headingTxt2.scrollFactor.y = 0;
			add(headingTxt2);
			
			
		}
		
		public function create3():void
		{
			...
			for each (t in Registry.level.solids)
			{
				for each (u in t.rect) {
					...
					if (u.@w > 1000 || u.@h > 1000)
					{
						FlxG.log("Warning on block for level " + Registry.levelNumber);
						
					}
					
					b = new FlxTileblock(u.@x, u.@y, u.@w, u.@h);
					if (Registry.levelType==1)
						b.loadTiles(Registry.ImgTiles, 10, 10, 0, true);
					else if (Registry.levelType==2)
						b.loadTiles(Registry.ImgTiles2, 10, 10, 0, true);
					else if (Registry.levelType==3)
						b.loadTiles(Registry.ImgTiles3, 10, 10, 0, true);
					else 
			...
			if (Registry.levelType==1) {				
				headingSpr2 = new FlxSprite(0, 0, null);
				headingSpr2.makeGraphic(FlxG.width, FlxG.height, 0xffd3bdb2);
				headingSpr2.scrollFactor.x = headingSpr2.scrollFactor.y = 0;
				add(headingSpr2);
				
			}
			if (Registry.levelType==2) {
				headingSpr2 = new FlxSprite(0, 0, null);
				headingSpr2.makeGraphic(FlxG.width, FlxG.height, Registry.BG_FACTORY_GREEN);
				headingSpr2.scrollFactor.x = headingSpr2.scrollFactor.y = 0;
				add(headingSpr2);
			}
			if (Registry.levelType==3) {
				...
				headingSpr2 = new FlxSprite(0, 0, null);
				headingSpr2.makeGraphic(FlxG.width, FlxG.height, Registry.BG_MGMT_BROWN);
				headingSpr2.scrollFactor.x = headingSpr2.scrollFactor.y = 0;
				add(headingSpr2);
			}
		...
		public function create5():void
		{
			...
			bubbles.makeParticles(Registry.ImgBubbles, 12, 32, true, 0);
			...
			crateShards.makeParticles(Registry.ImgCrateShards, 12, 32, true, 0);
...
/*				allCam = new FlxCamera(0,0, FlxG.width, FlxG.height); // we put the first one in the top left corner
			...
			if (Registry.playersNo==1) {
				helpOverlayP1 = new HelpOverlay(30+80, 10+20);
				helpOverlayP1.visible = false;
				helpOverlayP1.scrollFactor.x = 0;
				helpOverlayP1.scrollFactor.y = 0;
				add(helpOverlayP1);
				
				helpOverlayTextP1 = new FlxText(50+80, 12+20, 380, "", true);
...
/*				helpCamP2 = new FlxCamera(10+FlxG.width/2,10, FlxG.width/2, 50); // we put the first one in the top left corner
		...
		public function create7():void
		{
		
			headingTxt.text = "Loading particles...";
			
			speechBlock = new FlxTileblock( 0, 0, 180, 300);
			//speechBlock.height = 600;
			speechBlock.loadTiles(Registry.ImgSpeechTiles, 10, 10, 0, true);
			add(speechBlock);
			...
			playBtn = new FlxButton(100+80, 20+20, "Play Again", resetLevel);
			...
			restartBtn = new FlxButton(100+80, 20+20, "Restart Level", resetLevel);
			...
			headingTxt = null;
			headingTxt2.visible = false;
			headingTxt2 = null;
			headingSpr.visible = false;
			headingSpr = null;
			headingSpr2.visible = false;
			headingSpr2 = null;
			
			
		}
		
		public function create8():void
		{
			
			menuBtn = new FlxButton(300+80, 20+20, "To Menu", goToMenu);
			...
			pauseInstructions = new FlxText(100+80, 30 , FlxG.width/2, "Press R3 to resume.", true);
			...
			if (FlxG.usingJoystick) {
				pauseInstructions.text = "Press R3 to resume";
			}
		...
		override public function update():void
		{
			...
			if (totalTimePassed > 0.1 && hasCreatedLevel==false && creationStage == 1)
			{
				//FlxG.log("stage1" + totalTimePassed);
				create2();
				creationStage = 2;
			...
			{
				//FlxG.log("stage2"  + totalTimePassed);
				create3(); 
				creationStage = 3;
			...
			{
				//FlxG.log("stage3"  + totalTimePassed);
				create4();
				creationStage = 4;
			...
			{
				//FlxG.log("stage4"  + totalTimePassed);
				create5();
				creationStage = 5;
		...
		public function update2():void
		{
			...
			if (FlxG.keys.justPressed("P") || (FlxG.joystick.j1ButtonStartJustPressed)   || (FlxG.joystick.j2ButtonStartJustPressed) || FlxG.ouyaController.rightStick.pressed ) {
			...
			if (!levelFinished && !FlxG.keys.pressed(Registry.p1Jump) && !FlxG.joystick.j1ButtonAPressed && !FlxG.ouyaController.o.held) {
			...
			if ((FlxG.joystick.j1ButtonYJustPressed || FlxG.keys.justPressed(Registry.p1Piggyback)  || FlxG.keys.justPressed(Registry.p2Piggyback) || FlxG.ouyaController.y.pressed )&& FlxG.overlapWithOffset(player1, player2, 40,0) ) {
				if (!player1._isPiggyBacking &&  !player2._isPiggyBacking )
					FlxG.play(Registry.SndOnShoulders, 0.45);
			...
			if ( ((FlxG.keys.justPressed(Registry.p1Action) || FlxG.joystick.j1ButtonXJustPressed || FlxG.ouyaController.u.pressed) && Registry.playersNo==1 && levelFinished==false && player2._currentlyControlled) || ((FlxG.keys.justPressed(Registry.p2Action) || FlxG.joystick.j2ButtonXJustPressed || FlxG.ouyaController.u.pressed ) && Registry.playersNo==2 && (levelFinished==false))  ) {
...
/*			if (FlxG.keys.G) {
			...
			if ((FlxG.keys.justPressed(Registry.p1Switch) || FlxG.joystick.j1ButtonBJustPressed || FlxG.ouyaController.a.pressed) && Registry.playersNo == 1 && !player1._isPiggyBacking && levelFinished==false ) {
				switchCharacters();
			}
		...
		protected function touchedCheckPoint(Sprite1:FlxSprite, Sprite2:FlxSprite):void
		{
			...
			if ((Sprite1 is PlayerMale) && ((Sprite2 as CheckPoint).type)==0 ){
				...
				if ((Sprite2 as CheckPoint).checked==false)
					FlxG.play(Registry.SndCheckPoint, 0.8, false);
			...
			if (Registry.playersNo==2) {
				if (FlxG.keys.justPressed(Registry.p1Up) || FlxG.keys.justPressed(Registry.p2Up)  || FlxG.joystick.j1Stick1UpJustPressed  || FlxG.joystick.j2Stick1UpJustPressed || FlxG.joystick.j1ButtonYJustPressed ) {
					if (!(Sprite1 as PlayerMale)._isPiggyBacking &&  !(Sprite2 as PlayerFemale)._isPiggyBacking )
						FlxG.play(Registry.SndOnShoulders,0.25);
...
/*				if (FlxG.joystick.j1ButtonYJustPressed) {
		...
		public function getPickUp(Sprite1:FlxSprite, Sprite2:FlxSprite):void
		{
			...
			FlxG.play(Registry.SndPowerUp, 1.0);
		...
		public function killCharacter(Sprite1:FlxSprite,Sprite2:FlxSprite):void
		{
			...
			if ((Sprite1 as Character).dead == false) {
				FlxG.play(Registry.SndDeath, 1.0, false, true);
		...
		{
			if (withSound)
				FlxG.play(Registry.SwitchCharacters, 0.35);
		...
		public function levelOver():void
		{
			...
			if (levelFinished == false) {
				FlxG.music.stop();
				deathSound = FlxG.play(Registry.SndTagTone4, 1.0, false, true);
				levelFinished = true;
				player1._currentlyControlled = false;
				player2._currentlyControlled = false;
				Registry.canJump = false;
		...
		public function tryAgain():void
		{
			if (levelFinished == false) {
				gameOverScreen = true;
				FlxG.music.pause();
				deathSound = FlxG.play(Registry.SndTagTone1, 1.0, false, true);
				levelFinished = true;
				player1._currentlyControlled = false;
				player2._currentlyControlled = false;
